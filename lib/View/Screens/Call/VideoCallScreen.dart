...
class _VideoCallScreenState extends State<VideoCallScreen> {
  ...
  Future<void> _onCallEnd(BuildContext context) async {
    socket.emit("endcall", [widget.caller, widget.creceiver]);
    Duration dif = DateTime.now().difference(startTime);
    int callTime = dif.inSeconds;
    await chatMessagesViewModel.updateCallEnd(messageId ?? "", callTime);
